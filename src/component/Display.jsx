    ...
    return(
        <div className="w-full mx-auto bg-[#AC87C5] text-center py-12 px-4 my-16 lg:w-[850px] lg:mx-auto" id="calculator">
            ...
            <div>
                ...
                <button className="w-[150px] bg-[#756AB6] rounded-md text-xl mx-auto py-3 mt-4 border-2 shadow-md hover:bg-[#FFE5E5] hover:text-black" onClick={handleCalc}>
                    Calculate
                </button>
            </div>


            <div className="hidden w-full mx-auto bg-[#AC87C5] text-center py-12 px-4 my-16 lg:w-[850px] lg:mx-auto">
            <h2 className="mt-8 font-bold text-2xl mb-12">BMI Calculator</h2>
            <div className="box-content border w-[400px] md:w-[550px] mx-auto py-10">
            ...
            <button className="w-[180px] bg-[#756AB6] rounded-md text-xl mx-auto py-3 mt-4 border-2 shadow-md hover:bg-[#FFE5E5] hover:text-black" onClick={handleCalc}>
                Reset calculation
            </button>
            </div>
        </div>
